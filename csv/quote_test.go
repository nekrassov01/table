...
func Test_compiler_needsQuote(t *testing.T) {
	type fields struct {
		delimiter rune
	}
	type args struct {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			got := want{
				quoted: o.needsQuote(test.args.value),
			}
			testutil.AssertValue(t, got, test.want, "needsQuote")
		})
	}
}

func Test_compiler_quoteValue(t *testing.T) {
	type fields struct {
		delimiter rune
		quotes    []byte
		crlf      bool
