	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			got := want{
				...
				rowspans:   o.compiler.rowspans,
				colspans:   o.compiler.colspans,
...
func Test_arena_newConfig(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			config := o.newConfig(test.args.option, test.args.bodyRows)
			got := want{
...
func Test_arena_resumeConfig(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			config := o.resumeConfig(test.args.option, test.args.bodyRows)
			got := want{
				output:    config.output,
				ownsState: config.state == &o.config,
			}
